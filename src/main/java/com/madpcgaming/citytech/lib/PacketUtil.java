...
public class PacketUtil
{
	public static Packet createTileEntityPacket(String channel, int id, TileEntity te) {
	    ...
	    try {
	      dos.writeInt(id);
	      dos.writeInt(te.field_145851_c);
	      dos.writeInt(te.field_145848_d);
	      dos.writeInt(te.field_145849_e);
	      NBTTagCompound root = new NBTTagCompound();
	      te.func_145841_b(root);
	  ...
	  public static void writeItemStack(ItemStack spawnstack, DataOutputStream dataout) throws IOException {
	    if(spawnstack == null) {
	      ...
	      dataout.writeShort(spawnstack.getItem());
