...
public class CollidableCache {
	  ...
	  public CacheKey createKey(Class<? extends IPiping> baseType, Offset offset, ForgeDirection dir, boolean isStub) {
	    return new CacheKey(baseType, offset, dir, isStub);
	  }

	  public Collection<CollidableComponent> getCollidables(CacheKey key, IPiping piping) {
	  ...
	  public static class CacheKey {
	    ...
	    public final Class<? extends IPiping> baseType;
	    ...
	    public CacheKey(Class<? extends IPiping> baseType, Offset offset, ForgeDirection dir, boolean isStub) {
