...
public class BlockIndustrialFurnaceCore extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		...
		faceIconUnlit = iconRegister.registerIcon("citytech:IndustrialFurnace_Front_Unlit");
		...
		if(tileEntity != null)
		{
			if(!tileEntity.getIsValid())
			{
				if(tileEntity.checkIfProperlyFormed()){
					...
					if(world.isRemote)
						player.addChatMessage(new ChatComponentText("Industrial Furnace Completed"));
				}
			}
			if(tileEntity.getIsValid())
