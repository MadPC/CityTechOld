...
public class PowerInterfaceBC implements IPowerInterface
{
	...
	@Override
	public boolean canPipingConnect(ForgeDirection direction)
	{
		if(bcPower != null)
		{
			...
			return PowerHandlerUtil.canConnectReceivePower(bcPower);
		}
		return false;
	}
	...
	@Override
	public float receiveEnergy(ForgeDirection opposite, float canOffer)
	{
		if(bcPower != null)
		{
			if(bcPower instanceof IInternalPowerReceptor)
