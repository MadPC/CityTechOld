...
public class BasicTeslaBat implements ITeslaBat
{
	...
	public BasicTeslaBat()
	{
		
	}
	
	public BasicTeslaBat(int maxEnergyIO, int maxEnergyStored)
	{
		this(0, maxEnergyIO, maxEnergyStored, 0, 1, 200, maxEnergyIO);
	}
	
	public BasicTeslaBat(int maxEnergyIn, int maxEnergyStored, int maxEnergyOut)
	{
		this(0, maxEnergyIn, maxEnergyStored, 0, 1, 200, maxEnergyOut);
	}
	
	public BasicTeslaBat(int minEnergyReceived, int maxEnergyReceived, int maxEnergyStored, int minActivationEnergy, int powerLoss, int powerLossRegularity, int maxEnergyExtracted)
	{
	...
	protected void configure(int minEnergyReceived, int maxEnergyReceived, int maxEnergyStored, int minActivationEnergy, int powerLoss, int powerLossRegularity, int maxEnergyExtracted)
	{
	...
	protected void setMaxEneryReceived(int maxEnergyReceived)
	{
		this.maxEnergyReceived = maxEnergyReceived;
	}
