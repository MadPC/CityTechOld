...
import static com.madpcgaming.citytech.util.ForgeDirectionOffsets.offsetScaled;
import com.madpcgaming.citytech.render.BoundingBox;
import com.madpcgaming.citytech.render.RenderUtil;
import com.madpcgaming.citytech.render.VertexRotation;
import com.madpcgaming.citytech.render.VertexTransform;
import com.madpcgaming.citytech.render.VertexTransformComposite;
import com.madpcgaming.citytech.render.VertexTranslation;
...
public class ConnectionModeGeometry {
  ...
  static {
    ...
    float scale = 0.9f;
    BoundingBox refBB = PipingGeometryUtil.CORE_BOUNDS;
    refBB = refBB.scale(scale, scale, scale);
    refBB = refBB.scale(scale, 1, 1);

    double offset = (PipingGeometryUtil.HWIDTH * scale * scale) + PipingGeometryUtil.CONNECTOR_DEPTH;
  ...
  public static void renderModeConnector(ForgeDirection dir, Offset offset, IIcon tex, boolean tintSides) {
    ...
    Vector3d trans = PipingGeometryUtil.instance.getTranslation(dir, offset);
