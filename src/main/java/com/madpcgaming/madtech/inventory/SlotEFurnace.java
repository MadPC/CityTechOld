package com.madpcgaming.madtech.inventory;
...
public class SlotEFurnace extends Slot
{
    ...
    public SlotEFurnace(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
    {
